        ...
        <div class="card card-container">
          ...
          <!--  <form class="form-signin"> -->
              ...
              <!--  <input type="email" id="inputEmail" class="form-control" placeholder="Email address" required autofocus>-->
                  {{ Form::text('ime',null,['class' => 'form-control','type'=>'email','id'=>'inputEmail','placeholder'=>'Email adresa','required'=> 'autofocus']) }}
          ...
          <!--  </form><!-- /form -->
              {!! Form::close() !!}
            <a href="#" class="btn btn-lg btn-block btn-primary btn-h1-spacing">
                Forgot the password?
            </a>
        </div><!-- /card-container -->
    </div><!-- /container -->
